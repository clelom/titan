 ...
 *
 * Min accepts one number identifying the window size it operates on. This 
 * is a short (2 byte) value.
 *
 */
public class Min extends Task {
    
    public final static String NAME   = "min";
    public final static int    TASKID = 30;
