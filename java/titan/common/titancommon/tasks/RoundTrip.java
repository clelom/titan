 ...
 *
 */
public class RoundTrip extends Task {
    
    public final static String NAME   = "roundtrip";
    public final static int    TASKID = 33;
    ...
    public RoundTrip(RoundTrip s) {
    	super(s);
    }
    
    public Object clone() {
        return new RoundTrip(this);
    }
