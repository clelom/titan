...
public class PacketAligner {
   ...
   public static void realign(BTDataPacket [] datapackets) {
   ...
   public static void main(String [] args) {
      ...
      Vector vp0 = new Vector(1); vp0.add(new Integer(1)); vdatapackets.add(new BTDataPacket(new Date(1000), vp0, "a", channels));
      Vector vp1 = new Vector(1); vp1.add(new Integer(2)); vdatapackets.add(new BTDataPacket(new Date(4000), vp1, "a", channels));
//      Vector vp2 = new Vector(1); vp2.add(new Integer(3)); vdatapackets.add(new DataPacket(new Date(4100), vp2, "a", channels));
      Vector vp3 = new Vector(1); vp3.add(new Integer(4)); vdatapackets.add(new BTDataPacket(new Date(4200), vp3, "a", channels));
      Vector vp4 = new Vector(1); vp4.add(new Integer(5)); vdatapackets.add(new BTDataPacket(new Date(4300), vp4, "a", channels));
      Vector vp5 = new Vector(1); vp5.add(new Integer(6)); vdatapackets.add(new BTDataPacket(new Date(6000), vp5, "a", channels));
      
      BTDataPacket [] datapackets = new BTDataPacket[vdatapackets.size()];
      for (int i=0; i<vdatapackets.size();i++) {
         datapackets[i] = (BTDataPacket)vdatapackets.get(i);
      }
