 ...
 * Titan.h
 *
 * Titan messaging structure definitions.
 *
...
#define TITAN_PACKET_SIZE (TOSH_DATA_LENGTH - sizeof(uint16_t) - 3*sizeof(uint8_t))

/* sum of input and output ports */
#define TITAN_MAX_PORTS_PER_TASK 6 
...
/* Additional custom error codes are also allowed                             */
	...
	#define ERROR_SEGMENT_SIZE       5  /* Segment size is invalid */
  ...
  #define ERROR_NOT_IMPLEMENTED    9  /* Function has not been implemented */
  #define ERROR_OUT_FIFO_FULL     10  /* No packet could be obtained on getNextPacket */
  #define ERROR_IN_FIFO_EMPTY     11  /* Trying to get input data from empty buffer */
